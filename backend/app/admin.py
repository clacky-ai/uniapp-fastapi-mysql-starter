...
class UserAdmin(ModelView, model=User):
    ...
    column_details_list = [User.id, User.username, User.email, User.full_name, User.is_active, User.created_at, User.updated_at]
...
class PostAdmin(ModelView, model=Post):
    ...
    column_details_list = [Post.id, Post.title, Post.content, Post.author_id, Post.is_published, Post.created_at, Post.updated_at]
